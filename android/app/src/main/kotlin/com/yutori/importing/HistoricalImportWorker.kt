...
import com.yutori.ingestion.RawSms
import com.yutori.ingestion.SmsSource
        ...
        cursor.use { c ->
            ...
            while (c.moveToNext()) {
                ...
                try {
                    ...
                    when (outcome) {
                        is com.yutori.ingestion.IngestionOutcome.Ingested -> {
                            inserted++
                        ...
                        is com.yutori.ingestion.IngestionOutcome.Duplicate -> duplicates++
                    }
                } catch (e: Throwable) {
                    failures++
